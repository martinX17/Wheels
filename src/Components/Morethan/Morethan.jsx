...
const Morethan = () => {
  return (
    <div className='grid place-items-center justify-center'>
        <div className='relative grid place-items-center justify-center tablet:max-w-[960px] uppermid:max-w[1200px] desktop:max-w-[1190px] w-full my-24 tablet:flex tablet:items-center tablet:justify-start '>
