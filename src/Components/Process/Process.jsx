...
const Process = () => {
  return (
    <div className='grid place-items-center justify-center mt-32 mb-32'>
        <div className='flex flex-col items-center justify-center'>
            <p className='text-sm text-main-yellow tracking-[0.35rem]'>STEPS</p>
            <p className='text-white text-4xl font-bold my-3'>Bike Purchase <span className='text-main-yellow'>Process</span></p>
        </div>
        <div className='grid place-items-center p-5 gap-5 mt-10 lowermid:flex items-center justify-center lowermid:max-w-[760px] tablet:max-w-[960px] uppermid:max-w-[1200px]'>
