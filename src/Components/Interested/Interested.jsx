    ...
    <div className='w-full h-[350px] flex items-center justify-center bg-cover bg-center' style={{backgroundImage : `url(${Image})`}}>
      <div className='w-full grid place-items-center gap-7'>
        ...
        <div className='flex items-center gap-5'>
            <button className='flex items-center gap-2 bg-main-yellow px-7 py-2 rounded-full text-black font-light tracking-wider hover:bg-white hover:-translate-y-1 duration-300'>{<FaWhatsapp className='m-0 p-0' />}WhatsApp</button>
